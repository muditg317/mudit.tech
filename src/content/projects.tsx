...
// // const baz = projectFilter.firstWith.byField('subtitle')('Graphics Library for the Terminal');
// const baz = projectFilter.firstWith('subtitle','Graphics Library for the Terminal');
// type t2_ = typeof baz['title'];
